...
JX_Int
JX_ILUSetsweep( JX_Solver solver, JX_Real sweep)
{
...
jx_ILUDestroy(void *data)
{
   ...
   if (ilu_data)
   {
      ...
      {
         jx_ParCSRMatrixDestroy(jx_ParILUDataMatA(ilu_data));
         jx_ParILUDataMatA(ilu_data) = NULL;
      }
...
//       jx_ILUMaxRabs(A_diag_data, A_diag_j, k1, k2, nLU, rperm,
...
// JX_Int
// jx_ILUMaxRabs(JX_Real  *array_data,
//                  JX_Int   *array_j,
//                  JX_Int    start,
//                  JX_Int    end,
//                  JX_Int    nLU,
...
// /*--------------------------------------------------------------------------
//  * jx_ILULocalRCMBuildFinalPerm
//  *--------------------------------------------------------------------------*/

// JX_Int
// jx_ILULocalRCMBuildFinalPerm(JX_Int   start,
//                                 JX_Int   end,
//                                 JX_Int  *G_perm,
//                                 JX_Int  *perm,
//                                 JX_Int  *qperm,
...
// JX_Int
// jx_ILUGetLocalPerm(jx_ParCSRMatrix  *A,
//                       JX_Int          **perm_ptr,
//                       JX_Int           *nLU,
...
//    {
//       jx_ILULocalRCM(A_diag, 0, num_rows, &perm, &perm, 1);
//    }
