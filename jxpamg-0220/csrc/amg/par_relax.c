              ...
              jx_ParVector    *Vtemp )
{
   ...
   *-----------------------------------------------------------------------------*/
   ...
   if (relax_type == 0)
   {
      relax_error = jx_PAMGRelax0(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 1)
   {
      relax_error = jx_PAMGRelax1(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 2)
   {
      relax_error = jx_PAMGRelax2(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 3)
   {
      relax_error = jx_PAMGRelax3(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 4)
   {
      relax_error = jx_PAMGRelax4(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 5)
   {
      relax_error = jx_PAMGRelax5(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 6)
   {
      relax_error = jx_PAMGRelax6(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 7)
   {
      relax_error = jx_PAMGRelax7(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
   else if (relax_type == 9)
   {
      relax_error = jx_PAMGRelax9(par_matrix, par_rhs, cf_marker, relax_points,
                                  relax_weight, omega, par_app, Vtemp);
   }
