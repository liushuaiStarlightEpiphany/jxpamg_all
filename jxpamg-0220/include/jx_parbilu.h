...
typedef struct jx_ParBILUData_struct
{
   ...
   jx_ParBSRMatrix   *matA;
   jx_ParBSRMatrix   *matL;
   JX_Real           *matD;
   jx_ParVector      *D;
   jx_ParBSRMatrix   *matU;
   jx_ParBSRMatrix   *matmL;
   JX_Real           *matmD;
   jx_ParBSRMatrix   *matmU;
   jx_ParBSRMatrix   *matS;
   ...
   jx_BSRMatrix      *matALU_d; /* Matrix holding ILU of A (for A-smoothing) */
   jx_BSRMatrix      *matBLU_d; /* Matrix holding ILU of B */
   jx_BSRMatrix      *matSLU_d; /* Matrix holding ILU of S */
   jx_BSRMatrix      *matE_d;
   jx_BSRMatrix      *matF_d;
   jx_ParBSRMatrix   *Aperm;
   jx_ParBSRMatrix   *R;
   jx_ParBSRMatrix   *P;
...
JX_Int JX_BILUCreate( JX_Solver *solver );
JX_Int jx_BILUDestroy( void *ilu_vdata );
JX_Int JX_BILUDestroy( JX_Solver solver );
...
JX_Int jx_ILUSetupFGPBILU_v3(jx_ParBSRMatrix *A,JX_Int sweep,
                           jx_ParBSRMatrix **Lptr, jx_ParVector **D,
                           jx_ParBSRMatrix **Uptr, jx_ParBSRMatrix **Sptr,JX_Int **u_end);
...
JX_Int jx_par_Block_Jacobi_TriangularSolve(jx_ParBSRMatrix *A,
                     jx_ParVector    *f,
                     jx_ParVector    *u,
                     JX_Int           nLU,
                     jx_ParBSRMatrix *L,
...
JX_Int JX_ILUSolve( JX_Solver solver,
                ...
                JX_ParVector b,
                JX_ParVector x      );  
JX_Int jx_BILUSetup( void               *ilu_vdata,
                jx_ParBSRMatrix *A,
                jx_ParVector    *f,
                jx_ParVector    *u );
JX_Int JX_BILUSetup( JX_Solver      solver,
                jx_ParBSRMatrix *A,
                JX_ParVector     b,
                JX_ParVector     x );
JX_Int jx_BILUSolve( void               *ilu_vdata,
                jx_ParBSRMatrix *A,
                jx_ParVector    *f,
                jx_ParVector    *u );
JX_Int JX_BILUSolve( JX_Solver      solver,
                jx_ParBSRMatrix *A,
                JX_ParVector     b,
                JX_ParVector     x );
