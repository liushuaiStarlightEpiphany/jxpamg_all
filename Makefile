...
LIB      = -L $(JXPAMGDIR)/lib -lJXPAMG -L ${MPIDIR}/lib     -lmpi -lm #${LIB_MKL}
...
all: solver test_bsr_mv test_cpr test_bicgstab
...
# BiCGSTAB test program

# BiCGSTAB test program
BICGSTAB_TEST_OBJS = ./src/test_bsr_cprbicgstab.o

test_bicgstab: ${BICGSTAB_TEST_OBJS}
	${CC} -O3 -o test_bsr_cprbicgstab ${FLAGS} ${BICGSTAB_TEST_OBJS} ${LIB} ${CFLAGS}

clean:
	rm -rf solver test_bsr test_cpr test_bicgstab
	rm -rf ./src/*.o
