...
#define DEBUG_PRINTF(...)                                                                                                                                      \
    ...
    printf(__VA_ARGS__)
#define JXF_PRINTF printf
#define JXF_FPRINTF fprintf
#define jxf_printf printf
#define jxf_fprintf fprintf

#define jxf_fwrite fwrite
// #define jxf_fread fread
#define jxf_fread(ptr, size, count, stream)                                                                                                                 \
    do {                                                                                                                                                       \
