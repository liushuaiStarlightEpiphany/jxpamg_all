...
typedef struct jxf_ParILUData_struct
{
   ...
   jxf_ParCSRMatrix   *matmL;
   JXF_Real           *matmD;
   jxf_ParCSRMatrix   *matmU;
   ...
   jxf_CSRMatrix      *matALU_d; /* Matrix holding ILU of A (for A-smoothing) */
   jxf_CSRMatrix      *matBLU_d; /* Matrix holding ILU of B */
   jxf_CSRMatrix      *matSLU_d; /* Matrix holding ILU of S */
   jxf_CSRMatrix      *matE_d;
   jxf_CSRMatrix      *matF_d;
   jxf_ParCSRMatrix   *Aperm;
   jxf_ParCSRMatrix   *R;
   jxf_ParCSRMatrix   *P;
