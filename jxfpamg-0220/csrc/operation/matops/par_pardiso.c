...
JXF_Int 
jxf_pardiso(jxf_CSRMatrix *AA, jxf_Vector *bb, jxf_Vector *xx)
{
    int prtlvl = 0;
    int i;
    // Matrix
...
/**
 * \fn JXF_Int jxf_pardiso_factorize (jxf_CSRMatrix *AA, Pardiso_data *pdata, JXF_Int prtlvl)
 * 
...
JXF_Int jxf_pardiso_factorize (jxf_CSRMatrix *AA,
                             Pardiso_data *pdata,
                             JXF_Int prtlvl)
{
    JXF_Int status = 0;  
...
/**
 * \fn JXF_Int jxf_pardiso_solve (jxf_CSRMatrix *AA, jxf_Vector *bb, jxf_Vector *xx, Pardiso_data *pdata, JXF_Int prtlvl)
 * 
...
JXF_Int jxf_pardiso_solve (jxf_CSRMatrix *AA, 
                         jxf_Vector *bb, 
                         jxf_Vector *xx,
                         Pardiso_data *pdata,
                         JXF_Int prtlvl)
{
    ...
    JXF_Real *a1 = AA->data;
    // vector
    JXF_Real *b1 = bb->data;  /* RHS vector */
    JXF_Real *x1 = xx->data; /* Solution vector */
