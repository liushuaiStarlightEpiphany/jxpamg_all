...
{
   return (jxf_PAMGBuildCoarseOperatorKT(RT, par_A, par_P, 0, RAP_ptr));
}
                              ...
                              jxf_ParCSRMatrix **RAP_ptr )
{
   ...
   JXF_Int             *col_map_offd_P = jxf_ParCSRMatrixColMapOffd(par_P);
   ...
   JXF_Int              cnt, cnt_offd, cnt_diag, value;
...
/*!
 * \fn JXF_Int jxf_PAMGBuildCoarseOperatorAgg
 ...
 */ 
JXF_Int
jxf_PAMGBuildCoarseOperatorAgg( jxf_ParCSRMatrix  *RT,
                              jxf_ParCSRMatrix  *par_A,
                              jxf_ParCSRMatrix  *par_P,
                              JXF_Int            keepTranspose,
                              jxf_ParCSRMatrix **RAP_ptr )
{
   ...
   *-----------------------------------------------------------------------*/
   ...
   jxf_CSRMatrixTranspose(RT_diag, &R_diag, 0); 
   if (num_cols_offd_RT) 
   {
      jxf_CSRMatrixTranspose(RT_offd ,&R_offd, 0); 
      // R_offd_data = jxf_CSRMatrixData(R_offd);
      R_offd_i    = jxf_CSRMatrixI(R_offd);
      R_offd_j    = jxf_CSRMatrixJ(R_offd);
   }
...
#define JXF_SMP_PRIVATE i,ii,ic,i1,i2,i3,jj1,jj2,jj3,ns,ne,size,rest,jj_counter,jj_row_begining,A_marker,P_marker,r_a_product,r_a_p_product
#include "../../../include/jxf_smp_forloop.h"
...
#define JXF_SMP_PRIVATE i,j,k,jcol,ii,ic,i1,i2,i3,jj1,jj2,jj3,ns,ne,size,rest,jj_count_diag,jj_count_offd,jj_row_begin_diag,jj_row_begin_offd,A_marker,P_marker,r_a_product,r_a_p_product
#include "../../../include/jxf_smp_forloop.h"
