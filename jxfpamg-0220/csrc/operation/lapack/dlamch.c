...
/* **   
   Comment out this if block if EMIN is ok */
	if (iwarn) {
	    ...
	    jxf_printf("EMIN = %8i\n",(integer)lemin);
	    jxf_printf("If, after inspection, the value EMIN looks acceptable");
            jxf_printf("please comment out \n the IF block as marked within the"); 
            jxf_printf("code of routine DLAMC2, \n otherwise supply EMIN"); 
            jxf_printf("explicitly.\n");
	}
/* **   
