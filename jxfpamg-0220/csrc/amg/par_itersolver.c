                            ...
                            jxf_ParVector    *Vtemp )
{
   ...
   *-----------------------------------------------------------------------------*/
   ...
   switch (solverid)
   {
      case 0:
      {
         relax_error = jxf_PAMGRelax0(par_matrix, par_rhs, NULL, 0, weight, omega, par_app, Vtemp);
      }
      break;

      case 1:
      {
         relax_error = jxf_PAMGRelax1(par_matrix, par_rhs, NULL, 0, weight, omega, par_app, Vtemp);
      }
      break;

      case 2:
      {
         relax_error = jxf_PAMGRelax2(par_matrix, par_rhs, NULL, 0, weight, omega, par_app, Vtemp);
      }
      break;

      case 3:
      {
         relax_error = jxf_PAMGRelax3(par_matrix, par_rhs, NULL, 0, weight, omega, par_app, Vtemp);
      }
      break;

      case 4:
      {
         relax_error = jxf_PAMGRelax4(par_matrix, par_rhs, NULL, 0, weight, omega, par_app, Vtemp);
      }
      break;

      case 5:
      {
         relax_error = jxf_PAMGRelax5(par_matrix, par_rhs, NULL, 0, weight, omega, par_app, Vtemp);
      }
      break;

      case 6:
      {
         relax_error = jxf_PAMGRelax6(par_matrix, par_rhs, NULL, 0, weight, omega, par_app, Vtemp);
      }
      break;
   }
