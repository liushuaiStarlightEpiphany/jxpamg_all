...
fsls_AMGInitialize()
{
   ...
   JXF_Real   A_trunc_factor;
   JXF_Real   P_trunc_factor;
   JXF_Int      A_max_elmts;
   JXF_Int      P_max_elmts;
   ...
   JXF_Int      level_of_fill_in;  // the threshold 'p' in ILU(p)
 ...
 */
JXF_Int
fsls_AMGSetMaxLevels( void *data, JXF_Int max_levels )
{
   JXF_Int ierr = 0;
...
JXF_Int
fsls_AMGSetStrongThreshold( void *data, JXF_Real strong_threshold )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetMaxRowSum( void *data, JXF_Real max_row_sum )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetATruncFactor( void *data, JXF_Real A_trunc_factor )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetPTruncFactor( void *data, JXF_Real P_trunc_factor )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetAMaxElmts( void *data, JXF_Int A_max_elmts )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetPMaxElmts( void *data, JXF_Int P_max_elmts )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetCoarsenType( void *data, JXF_Int coarsen_type )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetInterpType( void *data, JXF_Int interp_type )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetCoarseThreshold( void *data, JXF_Int coarse_threshold )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetSMode( void *data, JXF_Int S_mode )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetTol( void *data, JXF_Real tol )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetMaxIter( void *data, JXF_Int max_iter )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetMinIter( void *data, JXF_Int min_iter )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetCycleType( void *data, JXF_Int cycle_type )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetCorrectiveType( void *data, JXF_Int corrective_type )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetRelaxWeight( void  *data, JXF_Real relax_weight )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetRelaxType( void  *data, JXF_Int relax_type )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int 
fsls_AMGSetRelaxOrder( void  *data, JXF_Int relax_order )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetRelaxSweeps( void  *data, JXF_Int relax_sweeps )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetRelaxSym( void  *data, JXF_Int relax_sym )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetPolyDegree( void  *data, JXF_Int poly_degree )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int 
fsls_AMGSetCoarsestSolver( void  *data, JXF_Int coarsest_solver )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetLevelOfFillIn( void  *data, JXF_Int level_of_fill_in )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetILUSmoothLevel( void  *data, JXF_Int ilu_smooth_level )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetRhsNrmThreshold( void  *data, JXF_Real rhsnorm_threshold )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetPrintLevel( void *data, JXF_Int print_level )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetCycleCount( void *data, JXF_Int cycle_count )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGGetCycleCount( void *data, JXF_Int *cycle_count )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetLastRelNrm( void *data, JXF_Real last_rel_nrm )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGGetLastRelNrm( void *data, JXF_Real *last_rel_nrm )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int 
fsls_AMGSetAveConvFactor( void *data, JXF_Real ave_conv_factor )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int 
fsls_AMGGetAveConvFactor( void *data, JXF_Real *ave_conv_factor )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetGridRelaxSweeps( void *data, JXF_Int *grid_relax_sweeps )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetGridRelaxType( void *data, JXF_Int *grid_relax_type )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetGridRelaxOrder( void *data, JXF_Int *grid_relax_order )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
JXF_Int
fsls_AMGSetGridRelaxWeight( void *data, JXF_Real *grid_relax_weight )
{
   JXF_Int ierr = 0;
   fsls_AMGData *amg_data = data;
...
{
   fsls_AMGData       *amg_data         = data;
   JXF_Int                 num_levels       = fsls_AMGDataNumLevels(amg_data);
   JXF_Int                 ilu_smooth_level = fsls_AMGDataILUSmoothLevel(amg_data);
 ...
 */
void
fsls_AMGComplx( void *data, JXF_Real *grid, JXF_Real *operater )
{
   fsls_AMGData    *amg_data   = data;
   JXF_Int              num_levels = fsls_AMGDataNumLevels(amg_data);
   fsls_CSRMatrix **A_array    = fsls_AMGDataAArray(amg_data);
    
   JXF_Int      total_coeffs    = 0;
   JXF_Int      total_variables = 0;
   JXF_Real   operat_cmplxty  = 0.0;
   JXF_Real   grid_cmplxty    = 0.0;
   JXF_Int     *num_coeffs      = fsls_CTAlloc(JXF_Int, num_levels);
   JXF_Int     *num_variables   = fsls_CTAlloc(JXF_Int, num_levels);
   JXF_Int      j; 
   ...
   grid_cmplxty   = ((JXF_Real) total_variables) / ((JXF_Real) num_variables[0]);
   operat_cmplxty = ((JXF_Real) total_coeffs) / ((JXF_Real) num_coeffs[0]);
...
{ 
   ...
   JXF_Int      max_levels        = fsls_AMGDataMaxLevels(amg_data);       // 25 by default
   JXF_Real   strong_threshold  = fsls_AMGDataStrongThreshold(amg_data); // 0.25 by default
   JXF_Real   max_row_sum       = fsls_AMGDataMaxRowSum(amg_data);       // 0.9 by default
   JXF_Real   A_trunc_factor    = fsls_AMGDataATruncFactor(amg_data);    // 0.0 by default
   JXF_Real   P_trunc_factor    = fsls_AMGDataPTruncFactor(amg_data);    // 0.0 by default
   JXF_Int      A_max_elmts       = fsls_AMGDataAMaxElmts(amg_data);       // 0 by default
   JXF_Int      P_max_elmts       = fsls_AMGDataPMaxElmts(amg_data);       // 0 by default
   JXF_Int      interp_type       = fsls_AMGDataInterpType(amg_data);      // 0 by default
   JXF_Int	    coarsen_type      = fsls_AMGDataCoarsenType(amg_data);     // 0 by default
   JXF_Int      coarse_threshold  = fsls_AMGDataCoarseThreshold(amg_data); // 100 by default  
   JXF_Int      S_mode            = fsls_AMGDataSMode(amg_data);           // 0 by default
   JXF_Int      print_level       = fsls_AMGDataPrintLevel(amg_data);      // 3 by default   
   ...
   JXF_Int             **CF_marker_array  = NULL;    

   /* local variables or arrays */
   JXF_Int  use_Jacobi_on_coarsest = 0;
   ...
   CF_marker_array = fsls_CTAlloc(JXF_Int*, max_levels);
   A_array[0] = A;
 ...
 */
JXF_Int
fsls_AMGSetRelaxParams( void *data, JXF_Int use_Jacobi_on_coarsest )
{
   fsls_AMGData       *amg_data = data;
   JXF_Int                 num_levels;
   JXF_Int                 coarsest_solver;   // solver type on the coarsest level
   ...
   JXF_Int j, cs, num_levels_minus_one;
   JXF_Int level = 0, ierr = 0;
   JXF_Int finest_size;
   JXF_Int coarsest_size;
   ...
   /* allocate memory */
   grid_relax_sweeps = fsls_CTAlloc(JXF_Int, num_levels);
   grid_relax_type   = fsls_CTAlloc(JXF_Int, num_levels);
   grid_relax_order  = fsls_CTAlloc(JXF_Int, 5);
   grid_relax_weight = fsls_CTAlloc(JXF_Real, num_levels); 
   ...
   *--------------------------------------------------------*/
   ...
   if (ilu_smooth_level > 0)
   {
      ...
      work        = fsls_CTAlloc(JXF_Real, 2*finest_size);
      index_array = fsls_CTAlloc(JXF_Int *, ilu_smooth_level);
      value_array = fsls_CTAlloc(JXF_Real *, ilu_smooth_level);
   ...
   *-----------------------------------------------------------------------------------------*/      
   ...
   {   
      ...
      { 
         ...
         full = fsls_CTAlloc(JXF_Real, coarsest_size*coarsest_size);
...
/*!
 * \fn JXF_Int fsls_AMGSetupParams
...
fsls_AMGSetupParams( void *amg_vdata )
{
   ...
   JXF_Int interp_type  = fsls_AMGDataInterpType(amg_data);
   JXF_Int coarsen_type = fsls_AMGDataCoarsenType(amg_data);  
   ...
   JXF_Real  min_weight;
   JXF_Real  max_weight;
   JXF_Real  op_complxty   = 0.0;
   JXF_Real  grid_complxty = 0.0;
   JXF_Real  num_nz0;
   JXF_Real  num_var0;
   ...
   if (num_levels >= 1) /* when num_levels = 1, we also output the information of coarsening and interpolation */
   {
      ...
      jxf_printf(" Coarsening    Type : ");
      switch (coarsen_type)
      {
         case RS_ORIGINAL:
            jxf_printf(" original RS from hypre\n");
         break;
         case RS_MODIFIED:
            jxf_printf(" modified RS by peghoty\n");
         break;
         case CLJP:
            jxf_printf(" CLJP\n");
         break;
      ...
      jxf_printf(" Interpolation Type : ");
      switch (interp_type)
      {
         case CLASSIC:
            jxf_printf(" modified classic interpolation\n");
         break;
         case DIRECT:
            jxf_printf(" direct interpolation\n");
         break;
         case ENERGYMIN:
            jxf_printf(" Energy-Minimizing based interpolation\n");
         break;      
         default:
            jxf_printf(" UNKNOWN\n");
         break;            
   ...
   jxf_printf(" -----------------------------------------------------------------------\n");
   jxf_printf("               nonzero          entries per row          row sums       \n");
   jxf_printf(" Lev   Rows    entries  sparse   min  max  avg        min        max    \n");
   jxf_printf(" -----------------------------------------------------------------------\n");

  /*---------------------------------------------------------
   *  Enter Statistics Loop (1st)
   *-------------------------------------------------------*/
   num_var0 = (JXF_Real) fsls_CSRMatrixNumRows(A_array[0]);
   num_nz0  = (JXF_Real) fsls_CSRMatrixNumNonzeros(A_array[0]);
   ...
   for (level = 0; level < num_levels; level ++)
   {
       ...
       sparse = num_nonzeros /((JXF_Real) fine_size * (JXF_Real) fine_size);
       
       /* modified by peghoty 2009/12/29 */
       op_complxty   += (JXF_Real)num_nonzeros;
       grid_complxty += (JXF_Real)fine_size;
       ...
       avg_entries = ((JXF_Real) total_entries) / ((JXF_Real) fine_size);

       jxf_printf(" %2d %7d %9d    %0.3f  %3d  %3d",
               level, fine_size, num_nonzeros, sparse, min_entries, max_entries);
       jxf_printf("  %5.1f    %9.2e  %9.2e\n", avg_entries, min_rowsum, max_rowsum);
   }
   /* modified by peghoty 2009/12/29 */
   op_complxty   /= num_nz0;
   ...
   {   
      ...
      jxf_printf(" -------------------------------------------------------------------------\n");
      jxf_printf("                     Entries/Row    min        max          row sums      \n");
      jxf_printf(" Lev   Rows x Cols     min max     weight     weight      min       max   \n");
      jxf_printf(" -------------------------------------------------------------------------\n");
      ...
      *-----------------------------------------------------*/
      ...
      for (level = 0; level < num_levels-1; level ++)
      {
          ...
          jxf_printf(" %2d %7d x %-7d %3d %3d",level,fine_size,coarse_size,min_entries,max_entries);
          jxf_printf("    %9.2e  %9.2e %9.2e  %9.2e\n",min_weight,max_weight,min_rowsum,max_rowsum);
      }
   
   } // end if (num_levels > 1)

   jxf_printf("\n >>> \033[34mGrid Complexity\033[00m    : %.3f\n", grid_complxty);   
   jxf_printf(" >>> \033[34mOperator Complexity\033[00m: %.3f\n", op_complxty); 

   return(0);
}

/*!
 * \fn JXF_Int fsls_AMGSolve
               ...
               fsls_Vector    *u  )
{
   ...
   JXF_Int corrective_type = fsls_AMGDataCorrectiveType(amg_data);  
   JXF_Int Solve_err_flag  = 0;

   JXF_Int max_levels    = fsls_AMGDataMaxLevels(amg_data);  
   JXF_Int num_variables = fsls_CSRMatrixNumRows(A);
   ...
   if (max_levels == 1)
   {
      ...
      {
         JXF_Real *full = fsls_CTAlloc(JXF_Real, num_variables*num_variables);
...
/*!
 * \fn JXF_Int fsls_AMGSolve_IterativeType
                             ...
                             fsls_Vector    *u  )
{
   ...
   /* variables in amg_data */   
   JXF_Real tol               = fsls_AMGDataTol(amg_data);
   JXF_Int    max_iter          = fsls_AMGDataMaxIter(amg_data);
   JXF_Int    min_iter          = fsls_AMGDataMinIter(amg_data);
   JXF_Int    print_level       = fsls_AMGDataPrintLevel(amg_data);
   JXF_Real rhsnorm_threshold = fsls_AMGDataRhsNrmThreshold(amg_data);
   ...
   *----------------------------------------------------------------------*/
   ...
   {   
      ...
      if (rhs_nrm > rhsnorm_threshold) 
      {   
         jxf_printf("    cycle    residual      factor      rel_res_nrm   \n");
      }
      else
      {
         jxf_printf("    cycle    residual      factor      abs_res_nrm   \n");
      }
      jxf_printf(" ----------------------------------------------------\n");
   ...
   *----------------------------------------------------------------------*/
   ...
   if (res_nrm_init)
   {
      conv_factor = pow( (res_nrm / res_nrm_init), (1.0 / ((JXF_Real) cycle_count)) );
   }
...
/*!
 * \fn JXF_Int fsls_AMGSolve_CorrectiveType
               ...
               fsls_Vector  **U_array )
{
   ...
   /* members in amg_data */
   JXF_Int                cycle_type        = fsls_AMGDataCycleType(amg_data);
   JXF_Int                num_levels        = fsls_AMGDataNumLevels(amg_data);
   JXF_Int               *grid_relax_sweeps = fsls_AMGDataGridRelaxSweeps(amg_data);
   JXF_Int               *grid_relax_type   = fsls_AMGDataGridRelaxType(amg_data);
   JXF_Int               *grid_relax_order  = fsls_AMGDataGridRelaxOrder(amg_data);
   JXF_Real            *grid_relax_weight = fsls_AMGDataGridRelaxWeight(amg_data);
   fsls_CSRMatrix   **A_array           = fsls_AMGDataAArray(amg_data);
   fsls_CSRMatrix   **P_array           = fsls_AMGDataPArray(amg_data);
   fsls_Vector       *Vtemp             = fsls_AMGDataVtemp(amg_data);
   fsls_Vector      **RNrm_array        = fsls_AMGDataRNrmArray(amg_data);   
   JXF_Int              **CF_marker_array   = fsls_AMGDataCFMarkerArray(amg_data);
   JXF_Real            *full              = fsls_AMGDataFull(amg_data);
   fsls_RelaxILUData *relax_ilu_data    = fsls_AMGDataRelaxILUData(amg_data);
   ...
   /* Local variables  */
   JXF_Int *lev_counter = NULL;
   JXF_Int  Solve_err_flag = 0;
   JXF_Int  j,k,level;
   JXF_Int  Not_Finished;
   JXF_Int  cycle_param; /* 0: finesest(L) 1: down cycle 2: coarsest 3: up cycle 4: finesest(R) */
   JXF_Int  coarse_grid, fine_grid;
   JXF_Int  relax_sweeps, relax_type, relax_order;
   JXF_Int  poly_degree = fsls_AMGDataPolyDegree(amg_data);
   JXF_Real relax_weight;
   JXF_Int  smooter = fsls_AMGDataRelaxType(amg_data);
   ...
   *---------------------------------------------------------------------*/
   ...
   lev_counter = fsls_CTAlloc(JXF_Int, num_levels);
   lev_counter[0] = 1;
...
fsls_AMGSolveParams( void *data )
{
   ...
   jxf_printf( " Real    Number of Levels           :  %d\n", num_levels);   
   jxf_printf( " Maximum Number of Cycles           :  %d\n", max_iter);
   jxf_printf( " Stopping Tolerance                 :  %.1e\n", tol); 
   jxf_printf( " Cycle Type(1 = V, 2 = W, etc.)     :  %d\n", cycle_type);
   jxf_printf( " Solve type(iterative or corrective): ");
   if (corrective_type)
   {
      jxf_printf( " Corrective Type\n\n");
   }
   else
   {
      jxf_printf( " Iterative Type\n\n");
   }
   ...
   if (num_levels == 1)
   {
      jxf_printf( "   Visiting Grid         :  Finest/Coarsest\n");
      jxf_printf( "   Number of Sweeps      :  %4d\n", grid_relax_sweeps[0]);
      jxf_printf( "   Type of Relaxation    :  %4d\n", grid_relax_type[0]);
   }
   else if (num_levels == 2)
   {
      jxf_printf( "   Visiting Grid         :  Finest  Coarsest\n");
      jxf_printf( "   Number of Sweeps      :  %4d   %4d \n",
                 grid_relax_sweeps[0], grid_relax_sweeps[num_levels-1]);
      jxf_printf( "   Type of Relaxation    :  %4d   %4d \n",
                 grid_relax_type[0], grid_relax_type[num_levels-1]);
   }
   else
   {
      jxf_printf( "   Visiting Grid         :  Finest Down  Up  Coarsest\n");
      jxf_printf( "   Number of Sweeps      :  %4d  %4d   %2d  %4d \n",
                 grid_relax_sweeps[0],grid_relax_sweeps[1],
                 grid_relax_sweeps[1],grid_relax_sweeps[num_levels-1]);
      jxf_printf( "   Type of Relaxation    :  %4d  %4d   %2d  %4d \n",
                 grid_relax_type[0],grid_relax_type[1],
                 grid_relax_type[1],grid_relax_type[num_levels-1]);
   }
   jxf_printf( "   ( 0|Jacobi    1|GS      2|SGS     3|SOR   4|Kaczmarz  \n");
   jxf_printf( "     5|Poly      6|MUMPS   8|ILU(p)  9|GE   10|GEP )\n");  
    
   jxf_printf( "   Order of Relaxation   :\n");

   if (num_levels == 1)
   {
      jxf_printf( "      Finest Grid  --> ");
      switch (grid_relax_order[0])
      {
            case FPFIRST:
            jxf_printf(" F points First\n"); break;
            case CPFIRST:
            jxf_printf(" C points First\n"); break;
            case FP_ONLY:
            jxf_printf(" F points Only\n"); break;
            case CP_ONLY:
            jxf_printf(" C points Only\n"); break; 
            case ASCEND:
            jxf_printf(" Ascendingly Order\n"); break;
            case DESCEND:
            jxf_printf(" Descendingly Order\n"); break;                     
      }
   }
   else if (num_levels == 2)
   {
   ...
   else 
   {
      for (cycle_param = 0; cycle_param < 5; cycle_param ++)
      {
         //if (cycle_param != 2)
         {
            ...
            {
               case 0:
               jxf_printf( "      Finest Grid(L)  --> "); break;
               case 1:
               jxf_printf( "          Down Cycle  --> "); break;
               case 2:
               jxf_printf( "       Coarsest Grid  --> "); break;
               case 3:
               jxf_printf( "            Up Cycle  --> "); break;
               case 4:
               jxf_printf( "      Finest Grid(R)  --> "); break;    
            }
...
/*!
 * \fn JXF_Int fsls_AMGCoarsenCLJP
                     ...
                     JXF_Int              *coarse_size_ptr )
{
   ...
   JXF_Real *measure_array = NULL;
   JXF_Int    *graph_array   = NULL;
   JXF_Int     graph_size;

   JXF_Int     i, j, k, jS, kS, ig;
   JXF_Int     ierr = 0;
   ...
   *------------------------------------------------------------*/
   ...
   measure_array = fsls_CTAlloc(JXF_Real, num_variables);
   ...
   *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
   ...
   graph_array = fsls_CTAlloc(JXF_Int, num_variables);
   for (i = 0; i < num_variables; i ++)
   {
      graph_array[i] = i;
   }

   CF_marker = fsls_CTAlloc(JXF_Int, num_variables);
...
/*!
 * \fn JXF_Int fsls_AMGCoarsenCLJPNew
 * \brief CLJP coarsening algorithm
 * \param *A pointer to the matrix
 * \param *S pointer to the strength matrix of A
 * \param **CF_marker_ptr pointer to the pointer to the CF marker
...
/*!
 * \fn JXF_Int fsls_InitAMGIndepSet
 ...
 */
JXF_Int
fsls_InitAMGIndepSet( fsls_ICSRMatrix *S, JXF_Real *measure_array, JXF_Real cconst )
{
   JXF_Int  S_num_nodes = fsls_ICSRMatrixNumRows(S);
   JXF_Int  i, ierr = 0;
...
fsls_AMGIndepSet( fsls_ICSRMatrix *S,
                  ...
                  JXF_Int             *IS_marker )
{
   JXF_Int    *S_i    = fsls_ICSRMatrixI(S);
   JXF_Int    *S_j    = fsls_ICSRMatrixJ(S);
   JXF_Int    *S_data = fsls_ICSRMatrixData(S);
...
/*!
 * \fn JXF_Int fsls_AMGClassicalInterp
...
{ 
   ...
   *-----------------------------------------------------------------------*/
   ...
   P_i    = fsls_CTAlloc(JXF_Int, n_fine+1);
   P_j    = fsls_CTAlloc(JXF_Int, P_size);
   P_data = fsls_CTAlloc(JXF_Real, P_size);

   P_marker = fsls_CTAlloc(JXF_Int, n_fine);
...
/*!
 * \fn JXF_Int fsls_AMGDirectInterp
...
{ 
   ...
   JXF_Real           alpha_up_sum    = 0.0;
   JXF_Real           alpha_down_sum  = 0.0;
   JXF_Real           beta_up_sum     = 0.0;
   JXF_Real           beta_down_sum   = 0.0;
   JXF_Real           alpha           = 0.0;
   JXF_Real           beta            = 0.0;
...
/*!
 * \fn JXF_Int fsls_AMGPTruncation
 ...
 */
JXF_Int
fsls_AMGPTruncation( fsls_CSRMatrix *A, JXF_Real trunc_factor, JXF_Int max_elmts )
{
   ...
   JXF_Real max_coef, row_sum, scale;
   JXF_Int    i, j, start;
   JXF_Int    now_checking, num_lost, next_open;
   JXF_Int    ierr = 0;
...
/*!
 * \fn JXF_Int fsls_AMGBuildCoarseOperator
...
/*!
 * \fn JXF_Int fsls_AMGAHTruncation
 ...
 */
JXF_Int
fsls_AMGAHTruncation( fsls_CSRMatrix *A, JXF_Real trunc_factor, JXF_Int max_elmts )
{
   JXF_Int     *A_i    = fsls_CSRMatrixI(A);
   JXF_Int     *A_j    = fsls_CSRMatrixJ(A);
   JXF_Real  *A_data = fsls_CSRMatrixData(A);
   ...
   JXF_Int      now_checking, num_lost, next_open;
   JXF_Real   max_coef = 0.0, row_sum, scale;
   JXF_Int      i, j, start, diag; 
   JXF_Int      ierr = 0;     
 ...
 *           updated(+1) before they enter the JXF_Real linked
                      ...
                      JXF_Int               *coarse_size_ptr )
{
   ...
   *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
   ...
   LoL_head = NULL;
   LoL_tail = NULL;
   lists = fsls_CTAlloc(JXF_Int, num_variables);
   where = fsls_CTAlloc(JXF_Int, num_variables);
   ...
   *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
   ...
   ST_i = fsls_CTAlloc(JXF_Int, num_variables+1);
   fsls_ICSRMatrixI(ST) = ST_i;

   ST_j = fsls_CTAlloc(JXF_Int, num_strong);
   ...
   *----------------------------------------------------------*/
   ...
   measure_array = fsls_CTAlloc(JXF_Int, num_variables);
 ...
 */
JXF_Int
fsls_AMGCreateS( fsls_CSRMatrix *A, JXF_Real strength_threshold, JXF_Int mode, fsls_ICSRMatrix **S_ptr )
{
   JXF_Int             *A_i           = fsls_CSRMatrixI(A);
   JXF_Int             *A_j           = fsls_CSRMatrixJ(A);
   JXF_Real          *A_data        = fsls_CSRMatrixData(A);
