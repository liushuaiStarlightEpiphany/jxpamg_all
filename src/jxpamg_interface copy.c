...
JXF_Int JXFPAMG_Solver_Interface(JXF_Int argc, char *argv[], JXF_Int row, JXF_Int *ia, JXF_Int  *ja, JXF_Real *a, 
                               JXF_Real *ser_x, JXF_Real *ser_b, JXF_Real tol, JXF_Int solver_id, JXF_Int num_functions, JXF_Int *iter)
{
   ...
   A_Par = jxf_CSRMatrixToParCSRMatrix(MPI_COMM_WORLD, A_Ser, row_part, col_part);

   int *partitioning; 
   jxf_ParCSRMatrixGetRowPartitioning(A_Par, &partitioning);
   b_Par = jxf_VectorToParVector(MPI_COMM_WORLD, b_Ser, partitioning);
   //x_Par = jxf_VectorToParVector(MPI_COMM_WORLD, x_Ser, partitioning);
                  ...
                  JXF_Int               *iter)
{
      ...
      case 102:  /* PAMG */
	   {
         // //   jxf_pardiso(par_matrix, par_rhs, par_sol);
         // //   jxf_PAMGRelax10(par_matrix,par_rhs,NULL,0,0.0,0.0,par_sol,NULL);
         //   jxf_Pre_Pardiso(par_matrix, par_rhs, par_sol);
         // //  jxf_LU(par_matrix,par_rhs,par_sol);
         // //   jxf_printf("1046\n");
   ...
   break;
      ...
      {
         if (myid == 0) jxf_printf("\n >>> Solver: PARDISO-PAMG-BiCGSTAB(%d) \n\n");
