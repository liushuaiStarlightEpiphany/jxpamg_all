...
Int mm_write_mtx_crd(char fname[], Int M, Int N, Int nz, Int I[], Int J[],
         Real val[], MM_typecode matcode);
Int mm_read_mtx_crd_data(FILE *f, Int M, Int N, Int nz, Int I[], Int J[],
        Real val[], MM_typecode matcode);
Int mm_read_mtx_crd_entry(FILE *f, Int *I, Int *J, Real *real, Real *img,
            MM_typecode matcode);

Int mm_read_unsymmetric_sparse(const char *fname, Int *M_, Int *N_, Int *nz_,
                Real **val_, Int **I_, Int **J_);
        ...
        Real **val, MM_typecode *matcode)
{
    ...
    *val = NULL;
    ...
    if (mm_is_complex(*matcode))
    {
        *val = (Real *) malloc(*nz * 2 * sizeof(Real));
...
Int mm_read_mtx_crd_entry(FILE *f, Int *I, Int *J, Real *real, Real *imag,
            MM_typecode matcode)
{
    if (mm_is_complex(matcode))
    {
